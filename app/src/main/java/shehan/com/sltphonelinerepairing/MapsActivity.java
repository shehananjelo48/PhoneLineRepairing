...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onLocationChanged(Location location) {
        ...
        Shehan =FirebaseDatabase.getInstance().getReference("Client");
        //client.getTelephone_No()=Shehan.push().getKey();

        client = new Client();
       client.setLatitude(location.getLatitude());
       client.setLongitude(location.getLongitude());

        Shehan.setValue(client).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
